...
describe('CSV Filter', () => {
    ...
    describe('when file has only recipe and', () => {
        ...
        test('header is empty, returns [] ', async () => {
            const header = ''
            const rows = ['1,02/05/2021,1000,790,21,,ACER Laptop,B76430134,N789789']
        ...
        test('there is IVA and IGIC, removes the row', async () => {
            const rows = ['1,02/05/2021,1000,790,21,4,ACER Laptop,B76430134,']
        ...
        test('there is not IVA nor IGIC, removes the row ', async () => {
            const rows = ['1,02/05/2021,1000,790,,,ACER Laptop,B76430134,']
        ...
        test('IGIC is not a number, removes the row', async () => {
            const rows = ['1,02/05/2021,1000,790,,er,ACER Laptop,B76430134,']
        ...
        test('IVA is not a number, removes the row', async () => {
            const rows = ['1,02/05/2021,1000,790,vhj,,ACER Laptop,B76430134,']
        ...
        test('neto is calculated wrong, removes the row', async () => {
            const rows = ['1,02/05/2021,1000,790,,4,ACER Laptop,B76430134,']
